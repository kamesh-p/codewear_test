...
const sss = () => {
  ...
  const handleChange = (e: any) => {
    ...
    // Clear the error message for the corresponding input field when typing
  ...
  const handleSignup = async (e: FormEvent) => {
    ...
    if (!data.email) {
      ...
      setErrors({ ...errors, email: "Enter a valid Gmail address" });
      return;
    }
    ...
    if (!data.password) {
      ...
      setErrors({
        ...errors,
        password:
          "Password must be at least 8 characters with one uppercase and special character",
      });
      return;
    }
                ...
                <form onSubmit={handleSignup}>
                  ...
                  absolute"
                    ...
                    <div className="text-sm mt-2">
                      ...
                      {conditionsMet.hasSpecialCharacter && (
                        <span className="text-green-500 pr-2">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4 inline"
                      ...
                      {conditionsMet.isEightCharacters && (
                        <span className="text-green-500 pr-2">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4 inline"
